// Make the class responsible for its own global pointer and "initialization on first use"
// (by using a private static pointer and a public static accessor method).
